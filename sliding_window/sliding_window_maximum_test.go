...
func Test_maxSlidingWindow(t *testing.T) {
	...
	tests := []struct {
		...
		{"3", args{[]int{7, 2, 4}, 2}, []int{7, 4}},
		{"2", args{[]int{1, 3, 1, 2, 0, 5}, 3}, []int{3, 3, 2, 5}},
		{"1", args{[]int{9, 10, 9, -7, -4, -8, 2, -6}, 5}, []int{10, 10, 9, 2}},
		{"1", args{[]int{-7, -8, 7, 5, 7, 1, 6, 0}, 4}, []int{7, 7, 7, 7, 7}},

		{"4", args{[]int{1, 3, -1, -3, 5, 3, 6, 7}, 3}, []int{3, 3, 5, 5, 6, 7}},
		{"5", args{[]int{1, 3, -1, -3, 5, 3, 6, 7}, 2}, []int{3, 3, -1, 5, 5, 6, 7}},
		{"6", args{[]int{1, 3, -1, -3, 5, 3, 6, 7}, 4}, []int{3, 5, 5, 6, 7}},
		{"7", args{[]int{1}, 1}, []int{1}},
	}
